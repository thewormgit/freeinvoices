...
<body>
  ...
  <script>
    window.onload = () => {
      ...
      loadingDiv.textContent = 'กำลังสร้าง PDF... กรุณารอสักครู่';
      ...
      setTimeout(() => {
        html2canvas(document.body, {
          ...
          // Update message and close after delay
          loadingDiv.textContent = 'ดาวน์โหลดเสร็จสิ้น! หน้าต่างจะปิดใน 2 วินาที...';
